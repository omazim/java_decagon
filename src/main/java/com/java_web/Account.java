...
public class Account extends AccountManager {
  ...
  public Account (HashMap<String, String> credentialsMap) {
    ...
    try {
      ...
      // System.out.println(accountType + " is in AccountTypes? " + Arrays.asList(AccountTypes.values().toString()).contains(accountType));
      // System.out.println(accountType + " is instance of AccountTypes? " + (AccountTypes.valueOf(accountType) instanceof AccountTypes));
      // System.out.println(Arrays.asList(AccountTypes.values()).indexOf(AccountTypes.valueOf(accountType)));
